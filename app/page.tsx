...
const Login = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      setError("");
      router.push("/fritzsport/pedidos");
    } catch (error) {
      console.log(error);
      setError("");
    } finally {
  ...
  return (
    ...
    >
      <div className="grid place-items-center mx-auto max-w-4xl w-full py-10 min-h-screen bg-black">
        <div className="flex justify-center items-center lg:flex-row flex-col gap-6 lg:gap-0 w-full shadow-md rounded-2xl">
          ...
          <div className="lg:w-1/2 w-full flex flex-col justify-center items-center py-6 bg-[#fff]">
            ...
            >
              ...
              <div className="flex flex-col w-full lg:px-5">
                ...
                <div className="grid place-items-center w-full mx-auto pt-7">
                  <button
                    type="submit"
                    className="bg-[#000] text-white text-lg w-full px-8 py-3 rounded-md uppercase font-semibold"
                  >
                    Iniciar Sesión
                  </button>
                </div>
